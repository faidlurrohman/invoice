...
export default function CustomerCode() {
  ...
  const ModalInput = () => {
    return (
      <Modal
        centered
        open={isShow}
        title={`${isEdit ? `Edit` : `Add`} Customer Code`}
          ...
          >
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please input name of customer code!",
                },
              ]}
            >
              <Input />
